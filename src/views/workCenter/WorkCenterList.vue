  ...
  <v-container fluid>
    <v-card class="ma-3">
      <v-row class="mt-5 ml-5 mr-5">
        <v-col cols="12" md="10">
          <v-toolbar flat>
            <v-toolbar-title>Work Center : </v-toolbar-title>
      ...
      >
        <template v-slot:top>
          <v-toolbar flat>
            ...
            <v-btn
              ...
              dark
              class="mb-2 mr-2"
              @click="$router.push(`/workcenter-add`)"
        ...
        <template v-slot:[`item.actions`]="{ item }">
          <v-icon
            small
            class="mr-2"
            @click="$router.push(`/workcenter-edit/${item.id}`)"
            v-if="authorize_edit"
            :style="{
...
export default {
  data: () => ({
    ...
    headers: [
      ...
      { text: "Work Center Name", value: "wc_name" },
      { text: "Work Center Group", value: "wc_group" },
      { text: "Labor Rate", value: "labor_rate" },
      { text: "FOH Rate", value: "foh_rate" },
      { text: "VOH Rate", value: "voh_rate" },
      { text: "Total Plan Hours", value: "sum_total_plan_hour" },
