    ...
    <v-data-table
      ...
      >
        ...
        <template v-slot:[`item.actions`]="{ item }">
          ...
          small
          class="mr-2"
          @click="$router.push(`/shift-edit/${item.id}`)"
          v-if="authorize_edit"
          :style="{
...
export default {
  data: () => ({
    ...
    headers: [
      ...
      { text: "Shift Name", value: "shift_name" },
      ...
      { text: "Break Start", value: "break_start" },
      { text: "Break End", value: "break_end" },
      { text: "Summary Time", value: "summary_time" },
