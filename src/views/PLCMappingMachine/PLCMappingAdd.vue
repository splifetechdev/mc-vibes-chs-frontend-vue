                ...
                <div v-if="activetab === 1 && callsoopentab == true" class="tabcontent">
                  ...
                  <v-row class="mb-10 mt-6">
                    <v-col cols="12" sm="12" md="5">
                      <v-text-field autofocus v-model="itemadd.plc_id" label="PLC ID" outlined dense></v-text-field>
                    </v-col>
                    <v-col cols="12" sm="12" md="5">
...
export default {
  ...
  methods: {
    ...
    async savedata() {
      ...
      const res_add = await api.addPLCMappingMachinet(this.itemadd);
