                ...
                <div v-if="activetab === 1 && callsoopentab == true" class="tabcontent">
                  <v-row class="mb-n6">
                    <v-col cols="12" sm="12" md="4">
                      <v-text-field autofocus v-model="itemadd.reason_code" label="Reason Code *" outlined
                        dense></v-text-field>
                    </v-col>
                    <v-col cols="12" sm="12" md="4">
...
export default {
  ...
  async mounted() {
    ...
    // console.log("udgroup.DOWN_TIME_CAUSE", udgroup.DOWN_TIME_CAUSE);
  ...
  methods: {
    ...
    async savedata() {
      ...
      const res_add = await api.addDownTimeCause(this.itemadd);
