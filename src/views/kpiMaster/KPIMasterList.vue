  ...
  <v-container fluid>
    <v-card class="ma-3">
      <v-row class="mt-5 ml-5 mr-5">
        <v-col cols="12" md="10">
          <v-toolbar flat>
            <v-toolbar-title>KPI Master : </v-toolbar-title>
        ...
        <template v-slot:top>
          <v-toolbar flat>
            ...
            <v-btn
              ...
              dark
              class="mb-2 mr-2"
              @click="$router.push(`/kpi-master-add`)"
...
export default {
  data: () => ({
    ...
    headers: [
      ...
      { text: "WC Name", value: "wcg_name" },
      { text: "Title", value: "kpi_title" },
  ...
  methods: {
    ...
    async loadItemMaste() {
      const result = await api.getKPIMasterList(
