...
export default {
  ...
  methods: {
    ...
    async loaddataEdit() {
      ...
      const result = await api.getKPIMasterByID(
        this.main_id,
      ...
      if (result.data[0]) {
        //item
        this.itemadd.set_up_by = result.data[0].set_up_by;
        this.rd_wc_row = result.data[0].set_up_by;
        this.itemadd.wcg_id = result.data[0].wcg_id;
        this.select_work_center_group = result.data[0].wcg_id;
        this.itemadd.wc_id = result.data[0].wc_id;
        this.select_work_center = result.data[0].wc_id;
        this.itemadd.title_id = result.data[0].title_id;
        this.select_title = result.data[0].title_id;
        this.itemadd.target = result.data[0].target;
        this.itemadd.uom = result.data[0].uom;
        // this.itemadd.date_start = this.formatDate(result.data[0].fdate_start);
        this.date1 = result.data[0].fdate_start;
        // this.dateFormatted1 = this.formatDate(result.data[0].fdate_start);
        // this.itemadd.date_end = this.formatDate(result.data[0].fdate_end);
        this.date2 = result.data[0].fdate_end;
        // this.dateFormatted2 = this.formatDate(result.data[0].fdate_end);
    ...
    async savedata() {
      ...
      const res_add = await api.updateKPIMaster(
