    ...
    <v-container class="pa-1" fluid>
      <v-card class="pa-12">
                ...
                <div v-if="activetab === 1 && callsoopentab == true" class="tabcontent">
                  <v-row class="mt-6">
                    <v-col cols="12" sm="12" md="3">
                      <v-select autofocus required outlined :items="itemmasterlist" v-model="itemadd.item_master_id"
                        item-value="id" :item-text="getgroupnameitemmaster" label="Item ID *" dense
                        @change="changeitemmaster"></v-select>
                    </v-col>

                    <v-col cols="12" sm="12" md="3">
                      <v-text-field background-color="#F5F5F5" disabled v-model="show_itemmaster_name" label="Item Name"
                        outlined dense></v-text-field>
                    </v-col>

                    <v-col cols="12" sm="12" md="2">
                      <v-text-field v-model="itemadd.rtg_id" label="RTG ID *" outlined dense
                        @keyup="searchrouting"></v-text-field>
                    </v-col>
                    ...
                    <v-col cols="12" sm="12" md="2">
                      <v-text-field type="number" min="0" v-model="itemadd.operation_cost" label="Operation Cost" outlined
                          dense disabled></v-text-field>
                    </v-col>
                  </v-row>
                  ...
                  <v-card class="pa-4">
                    <v-row class="mb-n10 mt-6">
                      <v-col cols="12" sm="12" md="2">
                        <v-text-field v-model="itemadd.opn_id" label="OPN ID *" outlined dense></v-text-field>
                      </v-col>

                      <v-col cols="12" sm="12" md="5">
                        <v-text-field v-model="itemadd.opn_name" label="OPN Name *" outlined dense></v-text-field>
                      </v-col>

                      <v-col cols="12" sm="12" md="5">
                        <v-select required outlined :items="workcenterlist" v-model="itemadd.work_center_id"
                          item-value="id" :item-text="getgroupnameworkcenter" label="Work Center *" dense @change="changworkcentertogetmch"></v-select>
                      </v-col>
                    </v-row>

                    <v-row class="mb-n10 mt-6">
                      <v-col cols="12" sm="12" md="2">
                        <v-text-field type="number" min="0" v-model="itemadd.no_of_machine" label="No. of Machine *" outlined
                          dense></v-text-field>
                      </v-col>

                      <v-col cols="12" sm="12" md="3">
                        <v-autocomplete required outlined :items="machinelist" v-model="datalistmachine_id"
                          item-value="id" :item-text="getgroupnamemachine" label="Machine *" dense chips small-chips
                          multiple></v-autocomplete>
                      </v-col>

                      <v-col cols="12" sm="12" md="2">
                        <v-select required outlined :items="unitlist" v-model="itemadd.unit_id" item-value="id"
                          :item-text="getgroupnameunit" label="Operation UM *" dense @change="changeunitname"></v-select>
                      </v-col>
                      <v-col cols="12" sm="12" md="3">
                        <v-select required outlined :items="datarouting" v-model="itemadd.predecessor" item-value="id"
                          :item-text="getnamerouting" label="Predecessor" dense  :disabled="disablepredecessor"></v-select>
                      </v-col>

                      <v-col cols="12" sm="12" md="2">
                        <v-select required outlined :items="dependencylist" v-model="itemadd.dependency" item-value="id"
                          item-text="name" label="Dependency" dense @change="changeunitname"></v-select>
                      </v-col>
                    </v-row>

                    <v-row class="mb-n10 mt-6">
                      <v-col cols="12" sm="12" md="2">
                        <v-text-field type="number" min="0" v-model="itemadd.setup_time" label="Set up Time" outlined
                          dense></v-text-field>
                      </v-col>
                      <v-col cols="12" sm="12" md="2">
                        <v-row>
                          ...
                          <v-col cols="12" sm="12" md="8">
                            <v-select class="ml-md-n10" required outlined :items="setuptimelist"
                              v-model="itemadd.setup_timehr_per" item-value="id" item-text="name" label=""
                              dense></v-select>
                          </v-col>
                        </v-row>
                      </v-col>
                      ...
                      <v-col cols="12" sm="12" md="3">
                        <v-text-field type="number" min="0" v-model="itemadd.eoq" label="EOQ" outlined
                          dense></v-text-field>
                      </v-col>
                      ...
                      <v-col cols="12" sm="12" md="2">
                        <v-text-field type="number" min="0" v-model="itemadd.pcs_hr" label="PCS/HR" outlined
                          dense @input="calculatepcs_hr(itemadd.pcs_hr)"></v-text-field>
                      </v-col>

                      <v-col cols="12" sm="12" md="2">
                        <v-text-field type="number" min="0" v-model="itemadd.hr_pcs" label="HR/PCS" outlined
                          dense  @input="calculatehr_pcs(itemadd.hr_pcs)"></v-text-field>
                      </v-col>
                    ...
                    <v-row class="mb-n10 mt-6">
                      <v-col cols="12" sm="12" md="3">
                        <v-text-field type="number" min="0" v-model="itemadd.qty_per" label="QTY PER" outlined
                          dense></v-text-field>
                      </v-col>
                      <v-col cols="12" sm="12" md="1"> </v-col>

                      <v-col cols="12" sm="12" md="3">
                        <v-text-field type="number" min="0" v-model="itemadd.qty_by" label="QTY BY" outlined
                          dense></v-text-field>
                      </v-col>
                      <v-col cols="12" sm="12" md="1"> </v-col>

                      <v-col cols="12" sm="12" md="3">
                        <v-text-field type="number" min="0" v-model="itemadd.scrap" label="SCRAP" outlined
                          dense></v-text-field>
                      </v-col>
                      <v-col cols="12" sm="12" md="1">
                        <h4 class="ml-n4">%</h4>
                    ...
                    <v-row class="mb-n10 mt-6">
                      <v-col cols="12" sm="12" md="2">
                        <v-text-field type="number" min="0" v-model="itemadd.batch" label="BATCH" outlined
                          dense></v-text-field>
                      </v-col>
                      <v-col cols="12" sm="12" md="1">
                        <h4 class="ml-n4">{{ showunitname }}</h4>
                      ...
                      <v-col cols="12" sm="12" md="2">
                        <v-text-field type="number" min="0" v-model="itemadd.over_lap_time" label="OVER LAP TIME" outlined
                          dense :disabled="disableoverlaptime"></v-text-field>
                      </v-col>
                      <v-col cols="12" sm="12" md="1">
                      ...
                      <v-col cols="12" sm="12" md="2">
                        <v-text-field type="number" min="0" v-model="itemadd.over_lap_unit" label="OVER LAP UNIT" outlined
                          dense :disabled="disableoverlapunit"></v-text-field>
                      </v-col>
                      <v-col cols="12" sm="12" md="1">
                        <h4 class="ml-n4">{{ showunitname }}</h4>
                      </v-col>
                    ...
                    <v-card-actions>
                      <v-row justify="center" class="mt-3">
                        <v-btn depressed width="100" class="mr-3  buttonblue" @click="savedatadialog()">
                          Submit
                        </v-btn>

                        <v-btn depressed width="120" class="mr-3  buttonred" @click="cleardata()">
                          Clear Data
                        </v-btn>
                  ...
                  <v-data-table v-if="datarouting.length > 0" :headers="headers" :items="datarouting" :search="search"
                    sort-by="fullname" class="elevation-1" :footer-props="{
                    ...
                    <template v-slot:[`item.opn_id`]="{ item }">
                      <a @click="toformeditdata(item)" class="text-decoration-underline">{{ item.opn_id }}</a>
                    </template>

                    <template v-slot:[`item.opn_name`]="{ item }">
                      <a @click="toformeditdata(item)" class="text-decoration-underline">{{ item.opn_name }}</a>
                    </template>

                    <template v-slot:[`item.actions`]="{ item }">
                      <v-icon small @click="deleteItem(item)" :style="{
        ...
        <v-dialog v-model="dialogSavedata" max-width="500px">
          <v-card>
            <v-card-title class="text-h5">Confirm change STD Cost to RTG ID {{itemadd.rtg_id}}?</v-card-title>
            <v-card-actions>
              <v-spacer></v-spacer>
              <v-btn color="blue darken-1" text @click="closeDialogSavedata">Cancel</v-btn>
...
export default {
  ...
  methods: {
    async loaddataEdit() {
      this.itemadd.item_master_id = parseInt(this.$route.params.item_master_id);
      this.itemadd.rtg_id = this.$route.params.rtg_id;
      await this.changeitemmaster(this.itemadd.item_master_id);
    ...
    async searchrouting() {
      ...
      if (this.itemadd.item_master_id && this.itemadd.rtg_id) {
        ...
        if (result.data.length > 0) {
          ...
          this.itemadd.predecessor = this.datarouting[this.datarouting.length - 1].id;

          this.disablepredecessor = false;
          this.disableoverlaptime = false;
          this.disableoverlapunit = false;
          this.itemadd.std_cost = this.datarouting[this.datarouting.length - 1].std_cost;
          this.checkdefaultstd_cost = this.datarouting[this.datarouting.length - 1].std_cost;
          this.itemadd.operation_cost = this.datarouting[this.datarouting.length - 1].operation_cost;
          // this.itemadd.std_cost = false;
        }
        else{
          const resultitemhavecost = await api.getRoutingItemhavestdCost(this.itemadd.item_master_id,this.itemadd.company_id);
    ...
    async deleteItemConfirm() {
      const res_del = await api.DeleteRouting(this.delete_item_id, this.main_u_define_module_id);
    ...
    async savedatadialog() {
      ...
      if (this.itemadd.work_center_id == "" || this.itemadd.work_center_id == 0) {
        this.$store.state.global_dialog = true;
        this.setupAlertDialog(
          true,
          "Failed!!!",
      ...
      if (this.itemadd.setup_timehr_per == "O" || this.itemadd.setup_timehr_per == "Q") {
      if (this.itemadd.eoq == "" || this.itemadd.eoq == 0 || this.itemadd.eoq == null) {
        this.$store.state.global_dialog = true;
        this.setupAlertDialog(
          true,
          "Failed!!!",
    ...
    if (this.itemadd.setup_timehr_per == "B") {
      if (this.itemadd.batch == "" || this.itemadd.batch == 0 || this.itemadd.batch == null) {
        this.$store.state.global_dialog = true;
        this.setupAlertDialog(
          true,
          "Failed!!!",
    ...
    async savedata() {
      ...
      let dataworkcenter= this.workcenterlist.find(item => item.id == this.itemadd.work_center_id);
      ...
      this.itemadd.over_lap_time = this.itemadd.over_lap_time ? this.itemadd.over_lap_time : null;
      this.itemadd.over_lap_unit = this.itemadd.over_lap_unit ? this.itemadd.over_lap_unit : null;
     ...
     if(this.itemadd.setup_timehr_per == "O" || this.itemadd.setup_timehr_per == "Q"){
      this.itemadd.std_setup_time_pc =  dataworkcenter.labor_rate / (this.itemadd.eoq / this.itemadd.setup_time);
     }else{
      this.itemadd.std_setup_time_pc =  dataworkcenter.labor_rate / (this.itemadd.batch / this.itemadd.setup_time);
     }
     this.itemadd.operation_cost = this.itemadd.std_dl + this.itemadd.std_foh +  this.itemadd.std_voh + this.itemadd.std_setup_time_pc;
      // this.$showLoader();
      ...
      if (this.modedata == "edit" && this.ideditmode != 0) {
        ...
        if (res_add.status == 200 || res_add.status == 201) {
          ...
          const res_addudefine = await api.updateByModuleMasterIdANDUdefineModuleId(
            this.ideditmode, this.main_u_define_module_id, this.itemaddudefine
          );

          if (res_addudefine.status == 200 || res_addudefine.status == 201) {
            this.$hideLoader();
            // location.href = `${location.origin}/routing-edit/${this.itemadd.rtg_id}/${this.itemadd.item_master_id}`
            ...
            this.setupAlertDialogPush(
              ...
              "Edit data success",
              "text-h5 green--text text-center",
              `/locationreloadroute/routing-edit/${this.itemadd.rtg_id}/${this.itemadd.item_master_id}`
            );
            return;
          } else {
    ...
    async toformeditdata(item) {
      ...
      if(this.itemadd.predecessor == 0 && !this.itemadd.over_lap_time && !this.itemadd.over_lap_unit){
        this.disablepredecessor = true;
          this.disableoverlaptime = true;
          this.disableoverlapunit = true;
      }else{
      ...
      if (item.u_define_master) {
        ...
        this.itemaddudefine.numeric1 = item.u_define_master.numeric1 ? item.u_define_master.numeric1 : "";
        this.itemaddudefine.numeric2 = item.u_define_master.numeric2 ? item.u_define_master.numeric2 : "";
        this.itemaddudefine.date1 = item.u_define_master.date1 ? this.formatDate(item.u_define_master.date1) : "";
        this.itemaddudefine.date2 = item.u_define_master.date2 ? this.formatDate(item.u_define_master.date2) : "";
        this.itemaddudefine.boolean1 = item.u_define_master.boolean1 == true ? 1 : 0;
        this.itemaddudefine.boolean2 = item.u_define_master.boolean2 == true ? 1 : 0;
        this.itemaddudefine.char1 = item.u_define_master.char1 ? item.u_define_master.char1 : "";
        this.itemaddudefine.char2 = item.u_define_master.char2 ? item.u_define_master.char2 : "";
        this.itemaddudefine.text1 = item.u_define_master.text1 ? item.u_define_master.text1 : "";
        this.itemaddudefine.text2 = item.u_define_master.text2 ? item.u_define_master.text2 : "";
      } else {
        this.itemaddudefine = Object.assign({}, this.defaultitemaddudefine);
        this.itemaddudefine.u_define_module_id = this.main_u_define_module_id;
      }
