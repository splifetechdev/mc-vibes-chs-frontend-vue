  ...
  <v-card class="ma-3">
    ...
    <v-row class="mt-5 ml-5 mr-5 mb-3">
        <v-col cols="12" md="12">
          <v-row>
            <!-- <v-toolbar flat> -->
              <v-toolbar-title class="text-h6 mt-4">User : </v-toolbar-title>
    ...
    <v-data-table
      ...
      >
        ...
        <template v-slot:[`item.actions`]="{ item }">
          ...
          small
          class="mr-2"
          @click="$router.push(`/user-edit/${item.id}`)"
          v-if="authorize_edit"
          :style="{
...
export default {
  data: () => ({
    ...
    headers: [
      ...
      { text: "Lastname(TH)", value: "lastname" },
      ...
      { text: "Status", value: "emp_status_name" },
